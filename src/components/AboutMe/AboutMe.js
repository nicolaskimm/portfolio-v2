        ...
        <div className='aboutMe_left'>
          <CSSTransitionGroup
            ...
            <p className='aboutMe_left_text'>
              ...
              <span className='aboutMe_left_text-tech'> NPM package manager</span>. Then came newer standard of <span className='aboutMe_left_text-tech'>ECMAScript - ES6</span>. Next was <span className='aboutMe_left_text-tech'>Express and Redux</span>, and in the end <span className='aboutMe_left_text-tech'>MongoDB </span>
              and simple unit tests using <span className='aboutMe_left_text-tech'>Mocha and Jest</span>.
              I cover the basics with most of them, after all I am just a beginner in IT world. Since that I am practicing a lot with Javascript and React. <br />
              <br />
